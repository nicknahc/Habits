                ...
                if showHelpOverlay {
                    ...
                    VStack {
                        Text("Need Help?")
                            .font(.title)
                            .fontWeight(.bold)
                        Text("Double-Tap Habits to indicate that you completed them today. You can also click the info button in the top right corner of each Habit and complete it there. Tap the 🕘 button to see Archived Habits where you can restore archived habits. Tap one of the inspired Habits to add it to your own Habits.")
                            .font(.body)
                        Button("Dismiss") {
                            self.showHelpOverlay = false
                        }
